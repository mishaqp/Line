...
public final class RootFileExecutorTest {
    ...
    public void absolutePathResolvesRelativeAgainstWorkspace() throws Exception {
        ...
        Assert.assertEquals("/data/media/0/Download",
                RootFileExecutor.absolutePath("/storage/emulated/0", "Download"));
        Assert.assertEquals("/data/media/0",
                RootFileExecutor.absolutePath("/sdcard", ""));
        try {
