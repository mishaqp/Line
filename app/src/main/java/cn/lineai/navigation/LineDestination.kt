...
sealed interface LineDestination : NavKey {
    ...
    data object Llm : LineDestination {
    ...
    data object Theme : LineDestination {
        override val screenId: String = "theme"
    }

    data object Output : LineDestination {
        override val screenId: String = "output"
    }

    data object ToolCallPreview : LineDestination {
    ...
    data object Storage : LineDestination {
        override val screenId: String = "storage"
    }

    data object Memory : LineDestination {
        override val screenId: String = "memory"
    }

    data object Data : LineDestination {
        override val screenId: String = "data"
    }

    data object ErrorLogs : LineDestination {
        override val screenId: String = "errorLogs"
    }

    data object KeepAlive : LineDestination {
        override val screenId: String = "keepAlive"
    }

    data object About : LineDestination {
