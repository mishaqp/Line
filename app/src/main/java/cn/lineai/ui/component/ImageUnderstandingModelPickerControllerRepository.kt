...
import cn.lineai.ui.model.ImageUnderstandingModelPickerSnapshot

interface ImageUnderstandingModelPickerLegacyGateway {
    fun models(): List<ModelConfig>
    fun selectedInternalId(): String
    fun selectImageUnderstandingModel(internalId: String)
}

class ImageUnderstandingModelPickerControllerRepository(
    private val gateway: ImageUnderstandingModelPickerLegacyGateway
    ...
    override fun selectModel(internalId: String) {
        gateway.selectImageUnderstandingModel(internalId)
    }
    ...
    companion object {
        ...
        private fun toItem(model: ModelConfig, selectedId: String): ImageUnderstandingModelItemUi {
            return ImageUnderstandingModelItemUi(
                internalId = model.id,
                name = model.name,
